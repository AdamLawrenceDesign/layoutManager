...
ListControllers.prototype.export = function()
{
	...
	{
		userId = window.location.href.slice(window.location.href.search('userId=') + 7, window.location.href.search('userName')-2);
		userName = window.location.href.slice(window.location.href.search('userName=') + 9, window.location.href.search('end')-1);
		layoutId = $(this).parent().parent().parent().attr('data-layoutId');
		productId = $(this).attr('data-productId');
		addInfo = 'webpage=' + 'layoutBuilder' +  '?%userId=' + userId + '?%userName=' + userName + '?%type=' + $(this).attr('data-type') + '?%productId=' + productId + '?%layoutId=' + layoutId + '?end';
